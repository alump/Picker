...
public class Picker extends AbstractComponent {
	...
	public interface ValueChangeListener {
		 ...
		 * @param value New value or null if no value selected
		 * @param index Index of value selected
		 */
	...
	/**
	 * Create new Picker with default generator using toString to generate
	 * plain text presentation of value.
	 */
	public Picker() {
	 ...
	 * @param caption Caption for Picker
	 */
	 ...
	 * @param generator Generator for value presentation
	 */
	 ...
	 * @param value Value set as current value. Will be added to picker if not
	 * in possible values yet.
	 */
